...
int	mlx_mouse_move_hook (void *win_ptr, int (*funct_ptr)(), void *param);
int	mlx_key_up_hook (void *win_ptr, int (*funct_ptr)(), void *param);
int	mlx_key_down_hook (void *win_ptr, int (*funct_ptr)(), void *param);
